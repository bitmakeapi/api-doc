...
limit | integer | false | limit number, max is 1000
to | integer | false | the timestamp of last kline
...
--------- | ------- | ------- | -----------
symbol | string | true | symbol name
limit | integer | false | limit numbers. default 100
...
--------- | ------- | ------- | -----------
symbol | string | false | symbol name
orderSide | string | false | 
orderType | string | false | 
fromId | long | false | Query start data ID
limit | long | false | limit number, default 100
